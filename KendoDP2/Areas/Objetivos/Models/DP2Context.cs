...
namespace KendoDP2.Models.Generic
{
    public partial class DP2Context : DbContext
    {
        ...
        private void SeedObjetivos()
        {
            ...
            TablaObjetivos.AddElement(new Objetivo("Objetivo Financiero 1.1", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Financiero 1")).ID, 50));
            TablaObjetivos.AddElement(new Objetivo("Objetivo Financiero 1.2", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Financiero 1")).ID, 50));
            ...
            TablaObjetivos.AddElement(new Objetivo("Objetivo Cliente 1.1", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Cliente 1")).ID, 50));
            TablaObjetivos.AddElement(new Objetivo("Objetivo Cliente 1.2", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Cliente 1")).ID, 50));
            ...
            TablaObjetivos.AddElement(new Objetivo("Objetivo Interno 1.1", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Interno 1")).ID, 50));
            TablaObjetivos.AddElement(new Objetivo("Objetivo Interno 1.2", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Interno 1")).ID, 50));
            ...
            TablaObjetivos.AddElement(new Objetivo("Objetivo Formación 1.1", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Formación 1")).ID, 50));
            TablaObjetivos.AddElement(new Objetivo("Objetivo Formación 1.2", TablaObjetivos.One(d => d.Nombre.Equals("Objetivo Formación 1")).ID, 50));
        }
    }
}