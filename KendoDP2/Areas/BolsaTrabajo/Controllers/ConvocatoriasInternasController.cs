        ...
        public ActionResult Postular(int ofertaID)
        {
            using (DP2Context context = new DP2Context())
            {
                ...
                OfertaLaboral oferta = context.TablaOfertaLaborales.FindByID(ofertaID);
                {
                    ...
                    OfertaLaboralXPostulante cruce = new OfertaLaboralXPostulante { Postulante = postulante, OfertaLaboral = oferta, EstadoPostulacionPorOfertaID = 1, EstadoPostulantePorOferta = eo };
