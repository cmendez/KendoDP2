...
namespace KendoDP2.Models.Generic
{
    public partial class DP2Context : DbContext
    {
        ...
        public List<Rol> SeedRolesMVega()
        {
            List<Rol> tablaRoles = new List<Rol>();
            int x = TablaRoles.All().Count;
            tablaRoles.Add(new Rol { Titulo = "Competencias", ID = x + 1, Area = "Evaluacion360", Nombre = "Competencias", EsWeb = true, Permiso = false });
            ...
            tablaRoles.Add(new Rol { Titulo = "Orgazacion", ID = x + 17, Area = "Organizacion", Nombre = "Organizaciones", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Organigrama", ID = x + 18, Area = "Organizacion", Nombre = "Organigrama", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Areas", ID = x + 19, Area = "Organizacion", Nombre = "Areas", EsWeb = true, Permiso = true });
            tablaRoles.Add(new Rol { Titulo = "Colaboradores", ID = x + 20, Area = "Organizacion", Nombre = "Colaboradores", EsWeb = true, Permiso = true });
            tablaRoles.Add(new Rol { Titulo = "Funciones", ID = x + 21, Area = "Organizacion", Nombre = "Funciones", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Puestos", ID = x + 22, Area = "Organizacion", Nombre = "Puestos", EsWeb = true, Permiso = true });
            tablaRoles.Add(new Rol { Titulo = "Linea de carrera", ID = x + 23, Area = "Organizacion", Nombre = "Historial", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Pagina persona", ID = x + 24, Area = "Organizacion", Nombre = "Intranet", EsWeb = true, Permiso = false });
        ...
        public List<Rol> SeedRolesAMontoya()
        {
            List<Rol> tablaRoles = new List<Rol>();
            int x = TablaRoles.All().Count;
            tablaRoles.Add(new Rol { Titulo = "Competencias", ID = x + 1, Area = "Evaluacion360", Nombre = "Competencias", EsWeb = true, Permiso = false });
            ...
            tablaRoles.Add(new Rol { ID = x + 31, Area = "Mi informacion", Nombre = "Informacion personal", EsWeb = false, Permiso = false });
            tablaRoles.Add(new Rol { ID = x + 32, Area = "Mi informacion", Nombre = "Mi equipo de trabajo", EsWeb = false, Permiso = false });
            tablaRoles.Add(new Rol { ID = x + 33, Area = "Mi informacion", Nombre = "Mis contactos", EsWeb = false, Permiso = false });
            tablaRoles.Add(new Rol { ID = x + 34, Area = "Mi informacion", Nombre = "Agenda", EsWeb = false, Permiso = false });
        ...
        public List<Rol> SeedRolesDCastroPcurichDlepageCmendezFsarmientoMsolorsanoCvazquesJcahuin()
        {
            List<Rol> tablaRoles = new List<Rol>();
            int x = TablaRoles.All().Count;
            tablaRoles.Add(new Rol { Titulo = "Competencias", ID = x + 1, Area = "Evaluacion360", Nombre = "Competencias", EsWeb = true, Permiso = false });
            ...
            tablaRoles.Add(new Rol { Titulo = "Orgazacion", ID = x + 17, Area = "Organizacion", Nombre = "Organizaciones", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Organigrama", ID = x + 18, Area = "Organizacion", Nombre = "Organigrama", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Areas", ID = x + 19, Area = "Organizacion", Nombre = "Areas", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Colaboradores", ID = x + 20, Area = "Organizacion", Nombre = "Colaboradores", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Funciones", ID = x + 21, Area = "Organizacion", Nombre = "Funciones", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Puestos", ID = x + 22, Area = "Organizacion", Nombre = "Puestos", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Linea de carrera", ID = x + 23, Area = "Organizacion", Nombre = "Historial", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Pagina persona", ID = x + 24, Area = "Organizacion", Nombre = "Intranet", EsWeb = true, Permiso = false });
            tablaRoles.Add(new Rol { Titulo = "Ofertas laborales", ID = x + 25, Area = "Reclutamiento", Nombre = "SolicitudOfertasLaborales", EsWeb = true, Permiso = true });
            tablaRoles.Add(new Rol { Titulo = "Solicitud de promocion", ID = x + 26, Area = "Reclutamiento", Nombre = "SolicitudPromociones", EsWeb = true, Permiso = false });
