    ...
    public class ReportesController : WSController
    {
        ...
        public ActionResult ListarObjetivosXBSC(int BSCId, int idperiodo)
        {
            using (DP2Context context = new DP2Context())
            {
                ...
                List<Objetivo> ListaObjetivos2aux = context.TablaObjetivos.Where(o => o.TipoObjetivoBSCID!=null && o.BSC!=null && o.TipoObjetivoBSCID == BSCId && o.BSC.PeriodoID == idperiodo).ToList();
