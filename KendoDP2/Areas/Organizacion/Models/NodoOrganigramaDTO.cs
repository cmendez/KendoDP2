    ...
    //  OJO : ¡¡¡¡¡ USAR SOLO DENTRO DE UN DP2Context !!!!!
        public NodoOrganigramaDTO(Puesto puesto)
        {
            ...
            //  Si existe colaborador...
                if (puesto.ColaboradorPuestos.Any(c => c.FechaIngresoPuesto <= DateTime.Today && (c.FechaSalidaPuesto == null || c.FechaSalidaPuesto > DateTime.Today)))
                {
                    //  Información del colaborador:
                    Colaborador colaborador = puesto.ColaboradorPuestos.Last(c => c.FechaIngresoPuesto <= DateTime.Today && (c.FechaSalidaPuesto == null || c.FechaSalidaPuesto > DateTime.Today)).Colaborador;
