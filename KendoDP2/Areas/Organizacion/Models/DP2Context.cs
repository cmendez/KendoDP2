...
namespace KendoDP2.Models.Generic
{
    ...
    public partial class DP2Context : DbContext
    {
        ...
        private void SeedColaboradores()
        {
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 25, ImagenColaboradorID = 7, Nombres = "Diana", ApellidoPaterno = "Lepage", ApellidoMaterno = "Hoces", Username = "dlepage", Password = "dlepage", CorreoElectronico = "diana@rh.com", Telefono = "8643456", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "UNMS", Roles = new List<Rol>() });
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 31, ImagenColaboradorID = 13, Nombres = "Christian", ApellidoPaterno = "Perez", ApellidoMaterno = "Ortiz", Username = "cperez", Password = "cperez", CorreoElectronico = "mono@rh.com", Telefono = "67567576", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = licenciado, CentroEstudios = "U. DE LIMA", Roles = new List<Rol>() });
