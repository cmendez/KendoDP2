...
namespace KendoDP2.Models.Generic
{
    ...
    public partial class DP2Context : DbContext
    {
        ...
        private void SeedColaboradores()
        {
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 20, ImagenColaboradorID = 2, Nombres = "Miguel", ApellidoPaterno = "Vega", ApellidoMaterno = "Buendía", Username = "mvega", Password = "mvega", CorreoElectronico = "miguel@rh.com", Telefono = "4567898", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = master, CentroEstudios = "PUCP", Roles = SeedRolesGenerales() });
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 23, ImagenColaboradorID = 5, Nombres = "Manuel", ApellidoPaterno = "Solorzano", ApellidoMaterno = "Cabeza", Username = "msolorzano", Password = "msolorzano", CorreoElectronico = "manolin@rh.com", Telefono = "5674245", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "PUCP", Roles = SeedRolesGenerales() }); 
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 24, ImagenColaboradorID = 6, Nombres = "Cesar", ApellidoPaterno = "Vasquez", ApellidoMaterno = "Flores", Username = "cvasquez", Password = "cvasquez", CorreoElectronico = "cesarin@rh.com", Telefono = "5674896", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "UNMS", Roles = SeedRolesGenerales() }); 
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 25, ImagenColaboradorID = 7, Nombres = "Diana", ApellidoPaterno = "Lepage", ApellidoMaterno = "Hoces", Username = "dlepage", Password = "dlepage", CorreoElectronico = "diana@rh.com", Telefono = "8643456", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "UNMS", Roles = SeedRolesGenerales() }); 
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 27, ImagenColaboradorID = 9, Nombres = "Pedro", ApellidoPaterno = "Curich", ApellidoMaterno = "Gonzales", Username = "pcurich", Password = "pcurich", CorreoElectronico = "pedro@rh.com", Telefono = "76575767", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "PUCP", Roles = SeedRolesGenerales() }); 
