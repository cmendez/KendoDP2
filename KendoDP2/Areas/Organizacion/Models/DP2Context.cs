...
namespace KendoDP2.Models.Generic
{
    ...
    public partial class DP2Context : DbContext
    {
        ...
        private void SeedColaboradores()
        {
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 19, ImagenColaboradorID = 1, Nombres = "Fortino Mario Alonso", ApellidoPaterno = "Moreno", ApellidoMaterno = "Reyes", Username = "admin", Password = "admin", CorreoElectronico = "cantinflas@rh.com", Telefono = "4456362", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = doctor, CentroEstudios = "PUCP", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 20, ImagenColaboradorID = 2, Nombres = "Miguel", ApellidoPaterno = "Vega", ApellidoMaterno = "Buendía", Username = "mvega", Password = "mvega", CorreoElectronico = "miguel@rh.com", Telefono = "4567898", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = master, CentroEstudios = "PUCP", Roles = TablaRoles.All() });
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 23, ImagenColaboradorID = 5, Nombres = "Manuel", ApellidoPaterno = "Solorzano", ApellidoMaterno = "Cabeza", Username = "msolorzano", Password = "msolorzano", CorreoElectronico = "manolin@rh.com", Telefono = "5674245", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "PUCP", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 24, ImagenColaboradorID = 6, Nombres = "Cesar", ApellidoPaterno = "Vasquez", ApellidoMaterno = "Flores", Username = "cvasquez", Password = "cvasquez", CorreoElectronico = "cesarin@rh.com", Telefono = "5674896", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "UNMS", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 25, ImagenColaboradorID = 7, Nombres = "Diana", ApellidoPaterno = "Lepage", ApellidoMaterno = "Hoces", Username = "dlepage", Password = "dlepage", CorreoElectronico = "diana@rh.com", Telefono = "8643456", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "UNMS", Roles = TablaRoles.All() });
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 27, ImagenColaboradorID = 9, Nombres = "Pedro", ApellidoPaterno = "Curich", ApellidoMaterno = "Gonzales", Username = "pcurich", Password = "pcurich", CorreoElectronico = "pedro@rh.com", Telefono = "76575767", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "PUCP", Roles = TablaRoles.All() });
            ...
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 29, ImagenColaboradorID = 11, Nombres = "Daiana", ApellidoPaterno = "Castro", ApellidoMaterno = "Marquina", Username = "dcastro", Password = "dcastro", CorreoElectronico = "daiana@rh.com", Telefono = "34566585", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "U. DE LIMA", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 30, ImagenColaboradorID = 12, Nombres = "Juan", ApellidoPaterno = "Cahuin", ApellidoMaterno = "Medina", Username = "jcahuin", Password = "jcahuin", CorreoElectronico = "cahuin@rh.com", Telefono = "36756585", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = bachiller, CentroEstudios = "PUCP", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 31, ImagenColaboradorID = 13, Nombres = "Christian", ApellidoPaterno = "Perez", ApellidoMaterno = "Ortiz", Username = "cperez", Password = "cperez", CorreoElectronico = "mono@rh.com", Telefono = "67567576", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = licenciado, CentroEstudios = "U. DE LIMA", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 32, ImagenColaboradorID = 14, Nombres = "Ever", ApellidoPaterno = "Mitta", ApellidoMaterno = "Flores", Username = "emitta", Password = "emitta", CorreoElectronico = "ever@rh.com", Telefono = "6756753", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = licenciado, CentroEstudios = "U. DE LIMA", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 33, ImagenColaboradorID = 15, Nombres = "Walter", ApellidoPaterno = "Erquinigo", ApellidoMaterno = "Pezo", Username = "werquinigo", Password = "werquinigo", CorreoElectronico = "walter@rh.com", Telefono = "97645585", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = licenciado, CentroEstudios = "U. DE LIMA", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 34, ImagenColaboradorID = 16, Nombres = "Katy", ApellidoPaterno = "Tucto", ApellidoMaterno = "Romero", Username = "ktucto", Password = "ktucto", CorreoElectronico = "ktucto@gmail.com", Telefono = "34243244", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = licenciado, CentroEstudios = "U. DE LIMA", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 35, ImagenColaboradorID = 17, Nombres = "Joao", ApellidoPaterno = "Chavez", ApellidoMaterno = "Yrigoyen", Username = "jchavez", Password = "jchavez", CorreoElectronico = "ktucto+RH@gmail.com", Telefono = "34234234", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = licenciado, CentroEstudios = "U. DE LIMA", Roles = TablaRoles.All() });
            TablaColaboradores.AddElement(new Colaborador { CurriculumVitaeID = 36, ImagenColaboradorID = 18, Nombres = "Carlos", ApellidoPaterno = "Lengua", ApellidoMaterno = "Lafosse", Username = "clengua", Password = "clengua", CorreoElectronico = "lengua@rh.com", Telefono = "34234234", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = licenciado, CentroEstudios = "U. DE LIMA", Roles = TablaRoles.All() });
