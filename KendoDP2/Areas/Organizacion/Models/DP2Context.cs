...
namespace KendoDP2.Models.Generic
{
    ...
    public partial class DP2Context : DbContext
    {
        ...
        private void SeedColaboradores()
        {
            ...
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 1, Nombres = "Fortino Mario Alonso", ApellidoPaterno = "Moreno", ApellidoMaterno = "Reyes", Username = "admin", Password = "admin", CorreoElectronico = "cantinflas@rh.com", Telefono = "4456362", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "PUCP", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 2, Nombres = "Miguel", ApellidoPaterno = "Vega", ApellidoMaterno = "Buendía", Username = "mvega", Password = "mvega", CorreoElectronico = "miguel@rh.com", Telefono = "4567898", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "PUCP", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 3, Nombres = "Franscisco", ApellidoPaterno = "Sarmiento", ApellidoMaterno = "Cumpa", Username = "psarmiento", Password = "psarmiento", CorreoElectronico = "francisco@rh.com", Telefono = "5367859", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "UNI", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 4, Nombres = "Christian", ApellidoPaterno = "Mendez", ApellidoMaterno = "Anchante", Username = "cmendez", Password = "cmendez", CorreoElectronico = "christian@rh.com", Telefono = "1345678", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "UNI", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 5, Nombres = "Manuel", ApellidoPaterno = "Solorzano", ApellidoMaterno = "Cabeza", Username = "msolorzano", Password = "msolorzano", CorreoElectronico = "manolin@rh.com", Telefono = "5674245", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "PUCP", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 6, Nombres = "Cesar", ApellidoPaterno = "Vasquez", ApellidoMaterno = "Flores", Username = "cvasquez", Password = "cvasquez", CorreoElectronico = "cesarin@rh.com", Telefono = "5674896", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "UNMS", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 7, Nombres = "Diana", ApellidoPaterno = "Lepage", ApellidoMaterno = "Hoces", Username = "dlepage", Password = "dlepage", CorreoElectronico = "diana@rh.com", Telefono = "8643456", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "UNMS", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 8, Nombres = "Hans", ApellidoPaterno = "Espinoza", ApellidoMaterno = "Aguinaga", Username = "hespinoza", Password = "hespinoza", CorreoElectronico = "hans@rh.com", Telefono = "54678969", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "UNI", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 9, Nombres = "Pedro", ApellidoPaterno = "Curich", ApellidoMaterno = "Gonzales", Username = "pcurich", Password = "pcurich", CorreoElectronico = "pedro@rh.com", Telefono = "76575767", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "PUCP", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 10, Nombres = "Andre", ApellidoPaterno = "Montoya", ApellidoMaterno = "Del Pino", Username = "amontoya", Password = "amontoya", CorreoElectronico = "dios@rh.com", Telefono = "7657567", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "UNI", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 11, Nombres = "Daiana", ApellidoPaterno = "Castro", ApellidoMaterno = "Marquina", Username = "dcastro", Password = "dcastro", CorreoElectronico = "daiana@rh.com", Telefono = "34566585", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "U. DE LIMA", Roles = allRoles });
            ...
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 13, Nombres = "Christian", ApellidoPaterno = "Perez", ApellidoMaterno = "Ortiz", Username = "cperez", Password = "cperez", CorreoElectronico = "mono@rh.com", Telefono = "67567576", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "U. DE LIMA", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 14, Nombres = "Ever", ApellidoPaterno = "Mitta", ApellidoMaterno = "Flores", Username = "emitta", Password = "emitta", CorreoElectronico = "ever@rh.com", Telefono = "6756753", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "U. DE LIMA", Roles = allRoles });
            ...
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 16, Nombres = "Katy", ApellidoPaterno = "Tucto", ApellidoMaterno = "Romero", Username = "ktucto", Password = "ktucto", CorreoElectronico = "ktucto@gmail.com", Telefono = "34243244", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "U. DE LIMA", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 17, Nombres = "Joao", ApellidoPaterno = "Chavez", ApellidoMaterno = "Yrigoyen", Username = "jchavez", Password = "jchavez", CorreoElectronico = "ktucto+RH@gmail.com", Telefono = "34234234", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "U. DE LIMA", Roles = allRoles });
            TablaColaboradores.AddElement(new Colaborador { ImagenColaboradorID = 18, Nombres = "Carlos", ApellidoPaterno = "Lengua", ApellidoMaterno = "Lafosse", Username = "clengua", Password = "clengua", CorreoElectronico = "lengua@rh.com", Telefono = "34234234", TipoDocumentoID = idDNI, PaisID = 1, EstadosColaboradorID = 1, GradoAcademico = gradoacademico, CentroEstudios = "U. DE LIMA", Roles = allRoles });
