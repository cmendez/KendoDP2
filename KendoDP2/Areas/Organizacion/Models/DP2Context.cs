...
namespace KendoDP2.Models.Generic
{
    ...
    public partial class DP2Context : DbContext
    {
        ...
        private void SeedColaboradorXPuesto()
        {
            ...
            TablaColaboradoresXPuestos.AddElement(new ColaboradorXPuesto { PuestoID = 2, Puesto = TablaPuestos.One(p => p.ID == 1), ColaboradorID = 2, Colaborador = TablaColaboradores.One(i => i.ID == 2), Sueldo = 2300, FechaIngresoPuesto = new DateTime(2013, 6, 1), FechaSalidaPuesto = new DateTime(2010, 7, 20), Comentarios = "Hizo una gran labor", IsEliminado = false });
            
            TablaColaboradoresXPuestos.AddElement(new ColaboradorXPuesto { PuestoID = 4, ColaboradorID = 2, Sueldo = 2500, FechaIngresoPuesto = new DateTime(2011, 1, 1), FechaSalidaPuesto = null, Comentarios = "asuuuuu", IsEliminado = false });
