...
namespace KendoDP2.Models.Generic
{
    ...
    public partial class DP2Context : DbContext
    {
        ...
        private void SeedColaboradores()
        {
            ...
            Colaborador crios = new Colaborador { ID = 20, Nombres = "Carmen", ApellidoPaterno = "Rios", ApellidoMaterno = "De La Puente", Username = "crios", Password = "crios", TipoDocumentoID = TablaTiposDocumentos.One(d => d.Descripcion.Equals("DNI")).ID, PaisID = 1, EstadosColaboradorID = 1, Roles = TablaRoles.All() };
            ...
            Colaborador jquintana = new Colaborador { ID = 21, Nombres = "Jimena", ApellidoPaterno = "Quintana", ApellidoMaterno = "Alvarado", Username = "jquintana", Password = "jquintana", TipoDocumentoID = TablaTiposDocumentos.One(d => d.Descripcion.Equals("DNI")).ID, PaisID = 1, EstadosColaboradorID = 1 };
            ...
            Colaborador rchavez = new Colaborador { ID = 22, Nombres = "Rodrigo", ApellidoPaterno = "Chavez", ApellidoMaterno = "Moreno", Username = "rchavez", Password = "rchavez", TipoDocumentoID = TablaTiposDocumentos.One(d => d.Descripcion.Equals("DNI")).ID, PaisID = 1, EstadosColaboradorID = 1 };
        ...
        private void SeedColaboradorXPuesto()
        {
            ...
            TablaColaboradoresXPuestos.AddElement(new ColaboradorXPuesto { PuestoID = 2, Puesto=TablaPuestos.One(p=>p.ID==2), ColaboradorID = 3, Colaborador = TablaColaboradores.One(i => i.ID == 3), Sueldo = 2500, FechaIngresoPuesto = new DateTime(2011, 1, 1), FechaSalidaPuesto = DateTime.MaxValue, Comentarios = "Continua haciendo una gran labor", IsEliminado = false });
